...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddDbContext<CubotNailsDbContext>((sp, options) =>
        {
        ...
        services.AddScoped<IApplicationDbContext>(sp => sp.GetRequiredService<CubotNailsDbContext>());
        ...
        services.AddDataProtection()
            .SetApplicationName("CubotNails")
            .PersistKeysToDbContext<CubotNailsDbContext>();
