...
public interface IApplicationDbContext
{
    ...
    // Conector de datos externos gobernado (ADR-0064): catalogo GLOBAL de plataforma (fuentes +
    ...
    DbSet<TenantTelegramConfig> TenantTelegramConfigs { get; }
    DbSet<StorageConfig> StorageConfigs { get; }
