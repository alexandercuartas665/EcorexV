...
public static class DirectorioModularDefaults
{
    ...
    [
        ...
        new("publica", "ciudad",            "Ciudad",             TerceroFieldType.Ciudad, 1, ShowInFilter: true),
        new("publica", "pais",              "Pais",               TerceroFieldType.Pais, 1),
        ...
        new("tributaria", "pais_rut",                     "38 - Pais",                               TerceroFieldType.Pais, 1),
        new("tributaria", "departamento",                 "39 - Departamento",                       TerceroFieldType.Departamento, 1),
        new("tributaria", "ciudad_rut",                   "40 - Ciudad / Municipio",                 TerceroFieldType.Ciudad, 1),
