...
public class EcorexDbContext : DbContext, IApplicationDbContext, IDirectorioModularDbContext, IDataProtectionKeyContext
{
    ...
    // Conector de datos externos gobernado (ADR-0064): catalogo GLOBAL de plataforma + concesiones.
    ...
    protected override void ConfigureConventions(ModelConfigurationBuilder configurationBuilder)
    {
        ...
        // Conector de datos externos gobernado (ADR-0064): el proveedor se persiste como texto.
    ...
    private static void ConfigureEntities(ModelBuilder modelBuilder, bool isNpgsql)
    {
        ...
        modelBuilder.Entity<TaskItem>(b =>
        {
            ...
            b.Property(x => x.RequesterDocument).HasMaxLength(60);
        ...
        modelBuilder.Entity<ReportDefinition>(b =>
        {
            ...
            // Vinculo a datos externos (ADR-0064): JSON con el mapeo dataset RDL -> ExternalDataSet + inputs.
        ...
        // Conector de datos externos gobernado (ADR-0064). Catalogo GLOBAL de plataforma, sin TenantId ni
