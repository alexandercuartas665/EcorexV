...
public sealed class CubotApiFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    public const string SingleEmail = "single@cubot.nails";
    public const string MultiEmail = "multi@cubot.nails";
    public const string SuperEmail = "super@cubot.nails";
    ...
    public async Task InitializeAsync()
    {
        ...
        var ctx = scope.ServiceProvider.GetRequiredService<CubotNailsDbContext>();
