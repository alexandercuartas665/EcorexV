...
/// <summary>
/// Gobernanza del conector de datos externos (ADR-0063) en matriz dual PostgreSQL / SQL Server.
///
...
public abstract class ExternalConnectorGovernanceTestsBase
{
    ...
    public async Task ConnectionString_IsStoredEncrypted_NeverPlaintext()
    {
        ...
        const string secret = "Server=db3dev;User Id=lector;Password=SUPERSECRETO;";
