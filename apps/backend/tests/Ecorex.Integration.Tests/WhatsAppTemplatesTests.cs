...
public abstract class WhatsAppTemplatesTestsBase
{
    ...
    private sealed class UnusedYCloudClient : IYCloudApiClient
    {
        ...
        public Task<YCloudSendResult> SendTemplateAsync(string apiKey, string fromPhone, string toPhone, string templateName, string language, IReadOnlyList<string> bodyParams, string? headerMediaType = null, string? headerMediaUrl = null, CancellationToken cancellationToken = default) => Fail<YCloudSendResult>();
